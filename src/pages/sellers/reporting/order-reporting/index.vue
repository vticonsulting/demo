<template lang="pug">
  .orders-view
    ...
    order-reporting-grid(:columns='columns', :orders='orders')
</template>

<script>
  import OrderReportingFilter from '@/components/reporting/order-reporting/filter'
  import OrderReportingGrid from '@/components/reporting/order-reporting/grid'
