<template lang="pug">
  .open-preempts-view
    ...
    open-preempts-grid(:items='openPreempts', :offers = 'offers')
...
<script>
  import OpenPreemptsEditTextFieldPopup from '@/components/order-management/open-preempts/edit-text-field-popup'
  import OpenPreemptsFilter from '@/components/order-management/open-preempts/filter'
  import OpenPreemptsGrid from '@/components/order-management/open-preempts/grid'
