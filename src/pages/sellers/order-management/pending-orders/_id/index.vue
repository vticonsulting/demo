...
<script>
  import AcceptOrderModal from '@/components/order-management/pending-orders/accept-order-modal'
  import RejectOrderModal from '@/components/order-management/pending-orders/reject-order-modal'
