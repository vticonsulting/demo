<template lang="pug">
  .order-search-details
    ...
    order-search-detail-actions(v-bind:orderId='order.id')
    order-search-detail-tabs
...
<script>
  ...
  import OrderSearchDetailActions from '@/components/order-management/order-search/detail-actions'
  import OrderSearchDetailTabs from '@/components/order-management/order-search/detail-tabs'
  ...
  export default {
    ...
    components: {
      OrderSearchDetailActions,
      OrderSearchDetailTabs
    },
