  ...
  .offer-tab-details.offers-container
    ...
    .order-tab.vui-m-bottom--medium(
      ...
      .vui-p-around--large.vui-tabs--scoped__content
        ...
        offer-tab-order-grid.flex-container(
          items = 'orderItems'
          v-bind:order = 'order'
          v-bind:orderId = '$route.params.id'
          v-bind:isMissedSpotsShown = 'isMissedSpotsShown'
    ...
    .offer-tab.vui-m-bottom--medium(
      ...
      .vui-p-around--large.vui-tabs--scoped__content
        ...
        offer-tab-offer-grid.flex-container(
          v-bind:order = 'order'
          v-bind:orderId = '$route.params.id'
        )
    order-line-current-info-popup(v-show='showCurrentInfoPopup' @close='showCurrentInfoPopup = false')
</template>
