    ...
    data () {
      return {
        ...
        spots: [
          ...
          {
            week: moment().add(21, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(28, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(35, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(42, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(47, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(54, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(61, 'days').weekday(1).format('MMM<br>DD')
          },
          {
            week: moment().add(68, 'days').weekday(1).format('MMM<br>DD')
          }
        ]
      }
    },
