<template lang="pug">
  .modal-mask.modal-transition(v-show='show', show='isShowDialog')
    ...
    .ng-modal-dialog(:style='dialogStyle')
      .ng-modal-dialog-content(ng-transclude='')
        .modal-container.ng-scope(style='width: 1200px')
          .modal-header.vui-m-bottom--large
            .modal-header.ng-modal-header
          ...
          .modal-body
            div
              .filter-validation.vui-theme--shade.error.vui-m-bottom--large(v-if='!isOrbitDetailsFound')
                ...
                .vui-grid.vui-grid--pull-padded
                  .vui-col--padded
                    .vui-scrollable--y(style='max-height: 480px')
                      orbit-details-popup-grid(items='items')
