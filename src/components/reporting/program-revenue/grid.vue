    ...
    table.vui-table.vui-no-row-hover
      thead
        ...
        tr
          ...
          th.u-width-medium This Year
          th.u-width-medium Last Year
      tbody(v-for='programRevenueDaypart in programRevenueDayparts')
        tr
          td(colspan='2')
            a(@click.prevent='toggleExpanded(programRevenueDaypart)')
...
<script>
  import ProgramRevenueSpotDetailModal from '@/components/reporting/program-revenue/spot-detail-modal'
